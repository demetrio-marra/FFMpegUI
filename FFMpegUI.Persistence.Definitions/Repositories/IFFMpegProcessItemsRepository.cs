...
namespace FFMpegUI.Persistence.Repositories
{
    public interface IFFMpegProcessItemsRepository : IFFMpegRepository
    {
        ...
        Task UpdateEndInfo(int processItemId, DateTime? endDate, long? convertedFileId, string? convertedFileName, long? convertedFileSize, bool? success, string? errorMessage);
